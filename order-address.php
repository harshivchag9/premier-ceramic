  ...
  <head>
    ...
    <script>
                          function validateOrderAddress()
                          {
                            ...
                            if(firstname.val().length == 0) {flag = false; }
                            if(lastname.val().length == 0)  {flag = false; } 
                            if(house.val().length == 0)     {flag = false; } 
                            if(street.val().length == 0)    {flag = false; } 
                            if(city.val().length == 0)      {flag = false; } 
                            if(zip.val().length == 0)       {flag = false; } 
                            if(state.val().length == 0)     {flag = false; } 
                            if(country.val().length == 0)   {flag = false; } 
                            if(phone.val().length == 0)     {flag = false; } 
                            if(email.val().length == 0)     {flag = false; } 
                            if(!flag)
                            {
        ...
        <div class="container-fluid">
          <div class="row">
            ...
            <div id="checkout" class="col-lg-9">
              <div class="box">
                <form method="POST" onsubmit=" return validateOrderAddress();" action="api/add-address.php" >
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input name="house" id="house" type="text" class="form-control" >
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group">
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-6 col-lg-3">
                        <div class="form-group">
                          ...
                          <input name="zip"  id="zip" type="text" pattern="[0-9]{6}" maxlength="6" class="form-control" required>
                        </div>
                      </div>
                      <div class="col-md-6 col-lg-3">
                        <div class="form-group">
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input name="phone" id="phone" pattern="[0-9]{10}" maxlength="10" type="text" class="form-control" required>
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group">
